...
- Strongest parts: bound-guided triage、dynamic fetch scheduling、COCO+MS MARCO multi-workload validation
- Remaining weaknesses: `msmarco_passage` 数据与 qrels/ground truth 需要确认；Lance runner 需要执行验证；Deep1M_synth 仍需生成或 fallback。
