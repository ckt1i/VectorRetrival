# Spec: Coarse Builder Evaluation

## Overview

Support explicit coarse builder identity configuration and evaluation workflow that produces comparable outputs across different builders.
...
| Builder | Identity |
|---------|----------|
| 仓库默认 | `hierarchical_superkmeans` |
| Faiss-based | `faiss_kmeans` |
