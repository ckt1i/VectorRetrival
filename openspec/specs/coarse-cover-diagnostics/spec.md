# Spec: Coarse Cover Diagnostics

## Overview

Pure coarse-cover diagnostics to measure IVF cluster selection quality independent of serving-side pruning (CRC, epsilon, candidate pruning).
