# Spec: Overlap-Aware Centroid Refinement

## Overview

Centroid refinement stage that updates coarse centroids after overlap assignment, reflecting multi-assignment membership in centroid geometry.
