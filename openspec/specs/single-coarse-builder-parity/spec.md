# Spec: Single Coarse Builder Parity

## Overview

Phased single-assignment coarse builder parity workflow comparing hierarchical_superkmeans, superkmeans, and faiss_kmeans with explicit gate decisions.
...
| Phase | Builders Compared | Gate Decision |
|-------|------------------|---------------|
| Phase 1 | hierarchical_superkmeans vs superkmeans | Pass → stop; Fail → Phase 2 |
| Phase 2 | superkmeans vs faiss_kmeans | Final recommendation |
