# Spec: Faiss Single Coarse Builder

## Overview

Faiss-style single IVF coarse clustering as an alternative coarse builder that exports single centroids and nearest-centroid assignments.
